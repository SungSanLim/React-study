...
export const BookProvider = ({ children }) => {
    ...
    const [filterParams, setFilterParams] = useState({ genre: '', search: '' }) // 책의 필터링에 사용될 값들의 객체
    const queryString = new URLSearchParams(filterParams).toString() // 브라우저 api로 제공되는 기능. 쿼리 문자열로 치환해줌
